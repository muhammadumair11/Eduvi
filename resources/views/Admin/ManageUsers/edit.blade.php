									...
									<div class="card-body">
										<form method="POST" action="{{ route("user.update", ['id' => $user->id]) }}" class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="user_type" class="form-control text-black-50 select2 w-100" >
                                                        <option <?php if($user->user_type == 'student') {
                                                            echo 'selected';
                                                        } ?> value="student" >Student</option>
                                                        <option <?php if($user->user_type == 'mentor') {
                                                            echo 'selected';
											...
											{{-- <div class="form-group row">
												...
												<div class="col-md-9">
													<input type="password" class="form-control" name="password" value="{{decrypt($admin->password)}}">
												</div>
                                                <div class="col-lg-3"></div>
                                                @error("password")
                                                    <div class="col-lg-9 py-2">
